...
test("operations source API: normalizes recoverable legacy source references before hydration", async () => {
  ...
  const legacyClaim = evidence.groups[1].claims[0] as { id: string; text: string; type?: string; confidence?: string; sourceCount?: unknown; affectedOutputs: string[]; contradictsClaimIds?: string[] | null; excerpt?: string | null };
