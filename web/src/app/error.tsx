...
// Route-segment error boundary. Without this, any render exception falls through
// to Next's blank "Application error" page. Kept self-contained (inline styles,
// no external CSS) so it renders even if a stylesheet is the thing that failed.
